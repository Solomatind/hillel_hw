...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        station.sortByFuelConsumptionWithReference();
        System.out.println("Sorted by fuel (method reference): ");
        System.out.println(Arrays.toString(cars));
        station.sortByFuelConsumptionWithLambda();
        System.out.println("Sorted by fuel (lambda): ");
        System.out.println(Arrays.toString(cars));
